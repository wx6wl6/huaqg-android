...
package com.qlp2p.doctorcar.ui;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorTxtColor = 0xFF333333; // by dondolari
	private int underlineColor = 0xFF333333;
	...
	private int tabTypefaceStyle = Typeface.NORMAL; // repaired by dondolari
...
//		tabTextColor = a.getColor(1, tabTextColor);
		...
		indicatorTxtColor = indicatorColor; // by dondolari
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (view instanceof ImageButton) {
                ...
                if (viewText instanceof TextView) {
                    if (position == i) {
                        tabTextView.setTextColor(indicatorTxtColor);
                    } else {
	...
	public void setIndicatorTxtColor(int indicatorColor) { // by dondolari
		this.indicatorTxtColor = indicatorColor;
		invalidate();
	}
